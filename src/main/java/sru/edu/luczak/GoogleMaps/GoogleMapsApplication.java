...
public class GoogleMapsApplication {
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		//I'm not sure if we need this here or if we can instead go through the application.properties folder
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/data?useSSL=false&serverTimezone=UTC", "root", "root");
			    ...
			    String excelFilePath = "C:\\Users\\csgla\\OneDrive\\Desktop\\GoogleMaps\\PickupPointInfo.xlsx";
